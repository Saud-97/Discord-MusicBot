...
Structure.extend(
  ...
  (Player) =>
    class extends Player {
         ...
         * @returns
         */
        setSendMusicMessage(client, message) {
            ...
            return (this.sendMusicMessage = message);
        }
        ...
        async sendNowplayingMessage(client) {
            let track = this.track
            let trackStartedEmbed = client.Embed()
            ...
            let nowPlaying = await client.channels.cache
                .get(this.textChannel)
                .send({
                    embeds: [trackStartedEmbed],
                    components: [client.createController(this.options.guild, this)],
                })
                .catch(client.warn);
