			...
			.on("trackStart", async (player, track) => {
				...
				setTimeout(() => {
					if (player.position > expectedPosition) {
						this.warn(
							`[${ player.guildName }] | Player: ${ player.options.guild
							} | A corrupted lavalink connection was detected, attempting to recreate the player`,
						);
						...
						setTimeout(() => {
							player = client.createPlayer(
								...
								{
									id: oldPlayer.guild,
									textChannel: oldPlayer.options.textChannel,
									voiceChannel: oldPlayer.options.voiceChannel,
								});
							player.connect();
